...
import cypherm from '../../photos/cypherm1watch.jpg';
import district from '../../photos/districtm1watch.jpg';
import processl1 from '../../photos/processl1watch.jpg';
import processsp1 from '../../photos/processsp1watch.jpg';
...
class Watches extends Component {
    ...
    items = [
        {
            title: 'ADIDAS CYPHER_M1 WATCH.',
            image: cypherm,
            price: 169,
        },
        {
            title: 'ADIDAS PROCESS_SP1 WATCH.',
            image: processsp1,
            price: 99,
        },
        {
            title: 'ADIDAS PROCESS_L1 WATCH.',
            image: processl1,
            price: 129,
        },
        {
            title: 'ADIDAS DISTRICT_M1 WATCH.',
            image: district,
            price: 239,
        },
    ];
    ...
    state = {
        shopItems:  this.items.map( item => (
            <ItemCarousel>
                <TextBlock>
                    <TextWatches>{item.title}</TextWatches>
                </TextBlock>
